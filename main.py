...
while True:
    ...
    match event:
        case "Add":
            ...
            website_link_label = sg.Text("Website Link")
            ...
            interview_3_date_label = sg.Text("Interview 3 Date")
            ...
            interview_3_date_input = sg.InputText(key="interview_3_date")
            interview_3_calendar_input = sg.CalendarButton("Select Date", target="interview_3_date", format="%Y-%m-%d")
            ...
            column2 = sg.Column([[company_name_input],
                                 ...
                                 [interview_3_date_input, interview_3_calendar_input],
                                 [notes_input]])
                ...
                match add_event:
                    case "ok":
                        ...
                        job_application = JobApplication(company_name, position_title,
                                                         add_values['website_link'], add_values['address'],
                                                         ...
                                                         add_values['interview_3_date'], add_values['notes'])
